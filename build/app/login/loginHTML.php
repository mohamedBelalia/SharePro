    ...
    <?php
        ...
        if(isset($_SESSION['loginFirst'])){
            ...
            <div class="bg-red-400 border-2 border-red-700 mx-auto w-[90%] text-white mb-10 p-4 rounded-md shadow-md">
                <p class="font-bold"><?=$_SESSION['loginFirst']?></p>
            </div>
            <?php
    ...
    ?>
    <main class="flex justify-center flex-col  items-center mt-24">

        <div class="w-96 p-6 bg-slate-300 rounded-md">
            <h1 class="text-center font-semibold text-2xl text-[#0c4a6e]">Login</h1>
            <hr class="mt-3">
            ...
            <div class="mt-6 flex justify-between items-center">
                <p>New In SharePic ?</p>
                <a href="index.php?section=Signup" class="text-[#232a6c]">Create Account</a>
            </div>
        </div>
